...
int main(int argc, char* argv[]) {
    ...
    args.addOption("dump", 'd', "Dump APF mesh before partitioning it", utils::Args::Required,
                   false);
    ...
    hid_t h5connect = H5Dcreate(h5file, "/connect", H5T_STD_U64LE, h5space, H5P_DEFAULT,
    ...
    if (groupTag) {
        ...
        hid_t h5group = H5Dcreate(h5file, "/group", H5T_STD_I32LE, h5space, H5P_DEFAULT,
                                  H5P_DEFAULT, H5P_DEFAULT);
        checkH5Err(h5group);
